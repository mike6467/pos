...
async def verify(phone: str = Form(...), code: str = Form(...), phone_code_hash: str = Form(...), password: str = Form("")):
    ...
    try:
        ...
        try:
            ...
            pass
        return HTMLResponse(f"<h3>Error during verification</h3><p>{str(e)}</p><p><a href='/'>Back</a></p>")
